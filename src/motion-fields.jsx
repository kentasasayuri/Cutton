...
import {MOTION_GROUPS,isLoopMotion,motionFrames} from '../server/motion-presets.mjs';
export default function MotionFields({draft,set}){
 ...
 const single=!isLoopMotion(preset);
