...
Use the local MCP tools `cutton_state`, `cutton_capabilities`, `cutton_command`, or run `node bin/cutton.mjs` in this application directory. Start the local app first.
